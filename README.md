...
Some Allsky parity items are intentionally scaffolded for later phases: remote upload execution, overlay live previews/presets, dark-frame median combine, full Allsky import, and custom module sandboxing.
