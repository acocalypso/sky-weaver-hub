...
- Built-in overlay module with editable lines, colors, placement controls, and a trusted post-capture module flow; custom module uploads stay disabled until sandboxing/signing is implemented.
