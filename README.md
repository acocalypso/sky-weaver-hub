...
Some Allsky parity items are intentionally scaffolded for later phases: SFTP/SCP/rsync/FTP upload targets, overlay live previews/presets, dark-frame median combine, full Allsky import, and custom module sandboxing.
