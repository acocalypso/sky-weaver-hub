...
- Allsky migration detection, preview, worker-backed image/product import, rollback, and Migration UI. Original Allsky files are copied, never deleted.
