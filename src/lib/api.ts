...
export interface CaptureStopResult { status: string; stop_mode: "graceful"; canceled_jobs: number; in_progress_jobs: number; in_progress_job_ids: string[]; message: string; }
